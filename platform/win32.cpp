...
static void handleMouseButton(LuGL::MOUSE_BUTTON button, bool pressed)
{
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch(msg)
    {
        ...
        // handle mouse input
        case WM_LBUTTONDOWN:
            handleMouseButton(LuGL::BUTTON_L, true);
            break;
        case WM_LBUTTONUP:
            handleMouseButton(LuGL::BUTTON_L, false);
            break;
        case WM_RBUTTONDOWN:
            handleMouseButton(LuGL::BUTTON_R, true);
            break;
        case WM_RBUTTONUP:
            handleMouseButton(LuGL::BUTTON_R, false);
            break;
        case WM_MOUSEMOVE:
